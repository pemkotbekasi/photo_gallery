                            ...
                            try {
                                ...
                                const Isi = data.data.xdt_api__v1__feed__user_timeline_graphql_connection.edges.map(d => {
                                    return {
                                        ...
                                        owner: Filename,
                                        cdn_image: `//raw.githubusercontent.com/pemkotbekasi/photo_gallery/main/picture/${Filename}/${d.node.code}.jpg`//`//cdn.jsdelivr.net/gh/pemkotbekasi/photo_gallery/picture/${Filename}/${d.node.code}.jpg`
                                    }
                                })
